...
public abstract class List {
  ...
  /**
   * nth(int n) returns the nth node of this list
   * @return the nth ListNode from the head
   */
  public ListNode nth(int n) throws InvalidNodeException{
    ListNode node = front();
    for (int i = 0; i < n-1; i ++){
      node = node.next();
    }
  ...
  /**
	* returns true if item is the entry of a ListNode in this
